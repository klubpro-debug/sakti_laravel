                    ...
                    <div class="entry clearfix">
                        ...
                        <div class="entry-image">
                            <a href="images/blog/full/17.jpg" data-lightbox="image"><img class="image_fade"
                                    src="{{ asset('uploads') }}/{{ $b->gambar }}" alt="Standard Post with Image"></a>
                        </div>
                        ...
                        <ul class="entry-meta clearfix">
                            ...
                            <li><i class="icon-folder-open"></i> <a href="#">{{ $b->kategori->nama }}</a></li>
                        </ul>
                                ...
                                <div class="tab-content clearfix" id="tabs-1">
                                    <div id="popular-post-list-sidebar">
                                        <div class="spost clearfix">
                                            <div class="entry-image">
                                                <a href="#" class="nobg"><img class="rounded-circle"
                                                        src="images/magazine/small/3.jpg" alt=""></a>
                                            </div>
                                            <div class="entry-c">
                                                <div class="entry-title">
                                        ...
                                        <div class="spost clearfix">
                                            <div class="entry-image">
                                                <a href="#" class="nobg"><img class="rounded-circle"
                                                        src="images/magazine/small/2.jpg" alt=""></a>
                                            </div>
                                            <div class="entry-c">
                                                <div class="entry-title">
                                        ...
                                        <div class="spost clearfix">
                                            <div class="entry-image">
                                                <a href="#" class="nobg"><img class="rounded-circle"
                                                        src="images/magazine/small/1.jpg" alt=""></a>
                                            </div>
                                            <div class="entry-c">
                                                <div class="entry-title">
                                ...
                                <div class="tab-content clearfix" id="tabs-3">
                                    <div id="recent-post-list-sidebar">
                                        <div class="spost clearfix">
                                            <div class="entry-image">
                                                <a href="#" class="nobg"><img class="rounded-circle"
                                                        src="images/icons/avatar.jpg" alt=""></a>
                                            </div>
                                            <div class="entry-c">
                                        ...
                                        <div class="spost clearfix">
                                            ...
                                            <div class="entry-c">
                                                <strong>Mary Jane:</strong> Possimus libero, earum officia architecto
                                                maiores....
                                            </div>
                                        </div>
                                        <div class="spost clearfix">
                                ...
                                <div class="iportfolio">
                                    <div class="portfolio-image">
                                        ...
                                        <div class="portfolio-overlay">
                                            <a href="http://vimeo.com/89396394" class="center-icon"
                            ...
                            <div class="oc-item">
                                <div class="iportfolio">
                                    <div class="portfolio-image">
                                        ...
                                        <div class="portfolio-overlay">
                                            <a href="images/blog/full/1.jpg" class="center-icon"
