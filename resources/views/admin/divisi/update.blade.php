...
<div class="container-fluid mt--7">
    ...
    <form action="{{ route('list_divisi.update', $divisi->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                        ...
                        <div class="col-md-11 ml-4 pr-0">
                            <div class="input-group mb-3">
                                <input type="text" name="nama" class="form-control" placeholder="Nama" aria-label="Nama"
                                    aria-describedby="button-addon2" value="{{ $divisi->nama }}">
                                <div class="input-group-append">
                                    <button class="btn btn-outline-primary" type="submit"
                                        id="button-addon2">Publish</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="card-body pt-0">
                                <div class="form-group">
                                    <textarea id="ckeditor" name="bio" required>{{ $divisi->bio }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 ml-0 pl-0 pr-5 pt-4">
                            <div class="form-group mb-3">
                                ...
                                <select name="kategori" class="form-control" data-toggle="select" title="Simple select"
                                    ...
                                    <option value="{{ $k->id }}"{{ $divisi->kategori->id == $k->id ? ' selected' : '' }}>{{ $k->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group mb-3">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="card-body pt-0">
                                <div class="form-group">
                                    <textarea id="ckeditor1" name="latar_belakang" required>{{ $divisi->latar_belakang }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-9">
                            ...
                            <div class="card-body pt-0">
                                <div class="form-group">
                                    <textarea id="ckeditor2" name="kegiatan" required>{{ $divisi->kegiatan }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
