<header id="header">
    ...
    <ul>
                    ...
                    <li class=""><a href="/berita"><div>Berita</div></a></li>
                    <li class=""><a href="#"><div>Divisi</div></a>
                        <ul>
                    ...
                    <li class=""><a href="/galeri"><div>Galeri</div></a></li>
                    <li class=""><a href="/about"><div>About</div></a>
                    </li>
                </ul>
            </nav>
        </div>
